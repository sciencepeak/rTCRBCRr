...
```{r}
raw_trust_clonotype_dataframe <- raw_clonotype_dataframe_list[["sample_01"]]

immunarch_style_dataframe <- raw_trust_clonotype_dataframe %>%
...
# input_dataframe <- convergent_clonotype_merged_dataframe
```
...
```{r}
usethis::use_data(raw_trust_clonotype_dataframe, overwrite = T)
